...
site:
  page: true
  route: /undergrad_advice/
---

# Other Pages with Great Advice

- Rob Candler, [Stuff Most Students Never Ask About Grad School](http://poplab.stanford.edu/pdfs/Candler-StuffMostGradStudentsDontAsk-ieee05.pdf)
...
- **Stay organized**:  Find and settle on a good way to track all of your due dates, and in particular have a good idea of when each upcoming major exam is for all of your classes. 
  ...
  - I use things like [Google Calendar](https://calendar.google.com/calendar/r) and [Todoist](https://todoist.com/app?lang=en) and map out my entire semester within the first week or two, but there are many other great apps. A physical planner is also an excellent choice.
...
- **Spaced repetition**: [Read up on it](https://en.wikipedia.org/wiki/Spaced_repetition) (there is some pretty good science on its effectiveness in learning) and work it into your study habits.  Cramming can have diminishing returns in proof-based classes, so it's worth visiting and revisiting material often enough to be familiar with it.

  - Apps like [Anki](https://apps.ankiweb.net/) are great for this.
...
- Get an idea of what Math is all about - there are great things beyond Calculus!
  ...
  - Also take a look at Garrity's book ([linked in the resources section](/resources/#resources-to-prepare-for-graduate-school)) for a short, condensed survey of some of the major topics and theorems you'll encounter.
  - One thing that was helpful to me was to make [graphs and diagrams](/resources/world-of-math/) of different areas of Math I encountered. Take a look, knowing the landscape you're traversing is valuable.
...
- <i class="fas fa-external-link-alt"></i> 
  You can find five sample exams [here.](http://www.math.ucla.edu/~iacoley/greprep.html)
- <i class="fas fa-book"></i> 
  Princeton Review, [Cracking the Math Subject GRE](https://www.amazon.com/gp/product/0375429727)

- Bill Shillito's Page:
...
- A UCSB Math Subject GRE Seminar:
 ...
 - Christian Parkinson's GRE seminar page: <https://www.math.ucla.edu/~chparkin/gre.html>
